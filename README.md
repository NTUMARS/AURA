...
styles/                    tokens · reset · layout · components  ("journal plate", warm white)
scripts/                   reveal · lazy-video · comparison (tile control bar) · mode-select (chips)
                           ...
                           section-spy (nav + film strip) · scroll-progress · copy-bibtex · main (Lenis)
...
tools/                     build_figs.sh · build_media.sh · report_media.sh · fill_dims.py · validate.py · bump_version.py
